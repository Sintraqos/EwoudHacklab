package main.java.lessonRevised;
...
public class Main {
    ...
    static MentorManager mentorManager;
    static ClassroomManager classroomManager;
    ...
    static void HandleInput() {
        while (true) {
            Logger.Log("""
                    ...
                    new Enums.LogStyle[]{Enums.LogStyle.LOG_STYLE_capitalize});
...
class Logger {
    ...
    public static void Log(String input) {
        Log(TextFormatting.logPattern, input, new Enums.LogStyle[]{Enums.LogStyle.LOG_STYLE_capitalize, Enums.LogStyle.LOG_STYLE_punctuate});
    }
    ...
    static void Log(String textFormat, String input) {
        System.out.printf((textFormat) + "%n", input);
    }
}
...
class Student extends PersonMaster {
    ...
    Map<Subject, Integer> studentSubjects;
    ...
    public String toString() {
        return String.format("%s - %s", personName, studentNumber);
    }
...
class Teacher extends PersonMaster {
    ...
    @Override
    public String toString() {
        return String.format("%s - %s", personName, employeeNumber);
    }
...
class StudentManager {
    ...
    StudentManager() {
        ...
        studentList.add(new Student("Student 1", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 2", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 3", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 4", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 5", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 6", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 7", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 8", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 9", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 10", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
        studentList.add(new Student("Student 11", new DateOfBirth(), "06 12341234", "student1@mail.com", new Address("SmithStreet", 1, "Smith Town", "1234AB"), studentList.size() + 1));
    }
    ...
    public void SendMail() {
        ...
        for (Student student : studentList) {
            ...
            for (Map.Entry<Subject, Integer> entry : student.studentSubjects.entrySet()) {
                ...
                if (!stringBuilder.toString().isEmpty()) {
                    ...
                    Logger.Log("Send mail to: %s", student.getName());
                }
            }
        }
    }
            ...
            for (Map.Entry<String, Boolean> entry : teacher.hoursDeclared.entrySet()) {
                ...
                if (!stringBuilder.toString().isEmpty()) {
                    Mailer.instance.SendMail(teacher, String.format("""
                                    ...
                                    This is an automated mail, and you don't need to respond back""",
                            teacher.getName(), stringBuilder));


                    Logger.Log("Send mail to: %s", teacher.getName());
                }
            }
        }
    }
...
class Classroom {
    ...
    @Override
    public String toString() {
        return String.format("%s - %s", classroomName, classMentor.toString());
    }
}
