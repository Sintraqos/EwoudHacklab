...
public class GUI_JPanelBackground extends JPanel {
    ...
    public GUI_JPanelBackground() {}

    /*
     *  Set image as the background with the SCALED style
     */
    public GUI_JPanelBackground(Image image)
    {
        this(image, SCALED);
    }
     ...
     */
    public GUI_JPanelBackground(Image image, int style)
    {
        setImage( image );
        setStyle( style );
     ...
     */
    public GUI_JPanelBackground(Image image, int style, float alignmentX, float alignmentY)
    {
        setImage( image );
        setStyle( style );
     ...
     */
    public GUI_JPanelBackground(Paint painter)
    {
        setPaint( painter );
        setLayout( new BorderLayout() );
    }
